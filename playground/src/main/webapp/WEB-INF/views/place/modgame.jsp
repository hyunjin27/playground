...
<form name="myform" method="post" action="gnp_mod.play">
<input type="hidden" name="p_no" value="${p_no}">
<input type="hidden" name="gnp_no" value="${map.gnp_no}">
<ul>
<li>게임 : <input type="text" id="g_no" name="g_no" size="5" value="${map.g_no}" required="required" readonly="readonly"></li>
<li>가격 : <input type="text" name="gnp_price" size="8" value="${map.gnp_price}" required="required">원</li>
<li>크레딧 : <input type="text" name="gnp_credit" size="8" value="${map.gnp_credit}" required="required">회</li>
<li>설명 : <textarea name="gnp_detail" cols="20" rows="5">${map.gnp_detail}</textarea></li>
